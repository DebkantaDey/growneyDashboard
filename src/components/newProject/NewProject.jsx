...
export default function NewProject() {
  ...
  useEffect(() => {
    axios.get(`https://growney.in/growney/public/index.php/api/new-project`)
      .then((response) => {
  ...
  const handelDelete = async (id) => {
    setIsLoading(true);
    try {
      const response = await fetch(`https://growney.in/growney/public/index.php/api/new-project/${id}`, {
        method: "DELETE",
      });
      if (!response.ok) {
