...
export default function EcoSystem() {
  ...
  useEffect(() => {
    axios.get(`https://growney.in/growney/public/index.php/api/eco-system`)
      .then((response) => {
  ...
  const handelDelete = async (id) => {
    setIsLoading(true);
    try {
      const response = await fetch(`https://growney.in/growney/public/index.php/api/eco-system/${id}`, {
        method: "DELETE",
      });
      if (!response.ok) {
